...
public class TestsForTaskOne {
    ...
    public void checkFirstFAQ() {
        ...
        String result = mainPage.getTextInFAQ(pom.button, pom.textInButton);
    ...
    public void checkSecondFAQ() {
        ...
        MainPage mainPage = new MainPage(driver);
        mainPage.openMainPage();
        String result = mainPage.getTextInFAQ(pom.buttonOne, pom.textInButtonOne);
    ...
    public void checkThirdFAQ() {
        ...
        MainPage mainPage = new MainPage(driver);
        mainPage.openMainPage();
        String result = mainPage.getTextInFAQ(pom.buttonTwo, pom.textInButtonTwo);
    ...
    public void checkFourFAQ() {
        ...
        MainPage mainPage = new MainPage(driver);
        mainPage.openMainPage();
        String result = mainPage.getTextInFAQ(pom.buttonThree, pom.textInButtonThree);
    ...
    public void checkFiveFAQ() {
        ...
        MainPage mainPage = new MainPage(driver);
        mainPage.openMainPage();
        String result = mainPage.getTextInFAQ(pom.buttonFour, pom.textInButtonFour);
    ...
    public void checkSixFAQ() {
        ...
        MainPage mainPage = new MainPage(driver);
        mainPage.openMainPage();
        String result = mainPage.getTextInFAQ(pom.buttonFive, pom.textInButtonFive);
    ...
    public void checkSevenFAQ() {
        ...
        MainPage mainPage = new MainPage(driver);
        mainPage.openMainPage();
        String result = mainPage.getTextInFAQ(pom.buttonSix, pom.textInButtonSix);
    ...
    public void checkEightFAQ() {
        ...
        MainPage mainPage = new MainPage(driver);
        mainPage.openMainPage();
        String result = mainPage.getTextInFAQ(pom.buttonSeven, pom.textInButtonSeven);
